...
public class CipherAlgorithmTests
{
    ...
    [Fact]
    public void Electrica_Encrypt_HOLA()
    {
        var algo = new ElectricaCipherAlgorithm();
        Assert.Equal("ELECTRICA:h,o,l,a", algo.Encrypt("HOLA"));
    }

    [Fact]
    public void Electrica_Encrypt_WithSpaces()
    {
        var algo = new ElectricaCipherAlgorithm();
        Assert.Equal("ELECTRICA:h,i,space,a", algo.Encrypt("HI A"));
    }

    [Fact]
    public void Electrica_Encrypt_IgnoresÑ()
    {
        var algo = new ElectricaCipherAlgorithm();
        Assert.Equal("ELECTRICA:a,b", algo.Encrypt("AÑB"));
    }

    [Fact]
    public void Electrica_Encrypt_EmptyInput()
    {
        var algo = new ElectricaCipherAlgorithm();
        Assert.Equal(string.Empty, algo.Encrypt(""));
    }
    ...
    [Fact]
    public void Electrica_Decrypt_Basic()
    {
        var algo = new ElectricaCipherAlgorithm();
        Assert.Equal("HOLA", algo.Decrypt("ELECTRICA:h,o,l,a"));
    }

    [Fact]
    public void Electrica_Decrypt_WithSpaces()
    {
        var algo = new ElectricaCipherAlgorithm();
        Assert.Equal("HI A", algo.Decrypt("ELECTRICA:h,i,space,a"));
    }

    [Fact]
    public void Electrica_Decrypt_InvalidPrefix()
    {
        var algo = new ElectricaCipherAlgorithm();
        var result = algo.Decrypt("GATO:h,o,l,a");
        Assert.StartsWith("Error", result);
    ...
    [Fact]
    public void Electrica_Roundtrip()
    {
        var algo = new ElectricaCipherAlgorithm();
        var original = "HELLO WORLD";
        var encrypted = algo.Encrypt(original);
